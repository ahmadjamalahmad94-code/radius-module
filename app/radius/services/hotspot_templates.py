...
def _saved_sessions_js() -> str:
    return (
        ...
        ".hr-ss-clear{font-size:12px!important;color:{{ACCENT_COLOR}};opacity:.85;cursor:pointer;"
        "font-weight:700;background:0;border:0;font-family:inherit;padding:0;min-height:0!important}\n"
        ...
        "width:30px;height:30px;min-height:0!important;padding:0;margin:0;border-radius:50%;"
        "cursor:pointer;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;"
        "font-size:15px!important;font-weight:800;line-height:1;flex-shrink:0}\n"
...
_RESPONSIVE_SAFETY_CSS = (
    ...
    "  input,select,button:not(.hr-lm-sq):not(.hr-ss-del):not(.hr-ss-clear),.btn,.hr-btn{\n"
