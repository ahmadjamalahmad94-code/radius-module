...
_DEFAULTS: dict[str, dict[str, str]] = {
    "tr181": {
        ...
        "wan_connection_status": "Device.PPP.Interface.1.ConnectionStatus",
    ...
    "tr098": {
        ...
        "wan_connection_status": "InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.1.ConnectionStatus",
