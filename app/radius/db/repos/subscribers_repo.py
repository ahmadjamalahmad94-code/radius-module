...
_COLS = (
    ...
    "working_days","connection_schedule","device_count","device_limit_mode","allowed_macs","metadata",
    # ── usage ──
...
def upsert_subscriber(s: Subscriber) -> Subscriber:
    values = (
        ...
        s.working_days, s.connection_schedule, s.device_count, s.device_limit_mode, s.allowed_macs, s.metadata or "{}",
