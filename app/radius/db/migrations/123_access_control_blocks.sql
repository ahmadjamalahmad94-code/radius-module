...
--
-- ملاحظة ترقيم (مُحلَّة): فرع feat/data-connection-oneclick استخدم أيضًا الرقم
-- 123 على فرعه. بعد دمج الفرعين أُعيد ترقيم ملفه إلى 132_data_connection.sql
-- (مع alias في الـrunner) فبقيت هذه البادئة 123 لهذا الملف وحده. الجدولان
-- مختلفان تمامًا فلا تصادم وظيفي. (راجع _MIGRATION_ALIASES في الـrunner.)
