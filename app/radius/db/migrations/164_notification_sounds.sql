-- ⚠️ تصادم ترقيم مقصودُ الإبقاء: يوجد أيضًا `164_tr069_remote_router_mgmt.sql`
-- (فرع TR-069). المُشغّل يفرز بالاسم لا بالرقم ويتتبّع المُطبَّق بالاسم، فكلاهما
-- يعمل بترتيبٍ حتميّ (notification قبل tr069 أبجديًّا) ولا تبعية بينهما.
-- لا يُعاد ترقيم هذا الملفّ: اسمه مُسجَّلٌ مُطبَّقًا على خوادم إنتاج، وتغييره
-- يجعلها تُعيد تشغيله فيسقط على ALTER TABLE بعمودٍ موجود.
