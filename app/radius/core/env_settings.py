...
REGISTRY: list[Setting] = [
    ...
    Setting("HOBERADIUS_EXPIRED_CAPTIVE_ENABLED", "network",
            ...
            help="الافتراضي: مُطفأ — المشترك المنتهي (كرت/PPPoE/هوتسبوت) يُرفض "
                 "اتّصاله كليًّا (Access-Reject) بلا أيّ جلسة. عند التفعيل يدويًّا: "
                 "المنتهي يتّصل لكنه يُوضَع في قائمة المنتهين (الجدار يَحصره "
                 "بالحديقة المسوّرة فيرى صفحة التجديد لدقائق) — خيار مقصود لمن "
                 "يريد بوّابة تجديد بدل الرفض."),
