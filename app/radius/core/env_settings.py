...
REGISTRY: list[Setting] = [
    ...
    Setting("HOBERADIUS_REMOTE_ACCESS_ALWAYS_ON", "network",
            ...
            help="الافتراضيّ العامّ لكل فتح: عند التفعيل تبقى كل الجلسات مفتوحة بلا "
                 "مهلة تلقائيّة (تبقى مقفولة على المصدر، لكنها لا تُغلق وحدها). "
                 "الأفضل إبقاؤه مُطفأ واستخدام «وصول دائم» لكل راوتر على حدة من "
                 "صفحة نفق الراوتر مع ضبط «مصدر مسموح» ثابت. الافتراضي مُطفأ."),
