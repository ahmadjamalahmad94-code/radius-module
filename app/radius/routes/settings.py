...
_SETTINGS_KEYS = [
    ...
    # 🔴 شبكاتٌ تبيع «رقمًا فقط»: رقمُ البطاقة هو السرّ. إعلانُه هنا
    # مرّةً واحدةً يجعله يسري على كلّ حزمها — بدل أن تُنسى حزمةٌ فيُغلق البابُ
    # في وجه زبائنها بلا رسالة (سمير ٢٠٢٦-٠٩-٠٣).
    ("cards.login_without_password_default",
     "الدخول برقم البطاقة فقط — افتراض الشبكة", "0"),
