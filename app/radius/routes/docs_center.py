...
CATEGORIES: dict[str, dict] = {
    ...
    "subscribers": {
        ...
        "pages": [
            ...
            {
                "slug": "device-limit",
                "title": "حدّ الأجهزة وركل الجلسات",
                "desc": "عدد الأجهزة المتزامنة لكل مشترك/كرت، رفض مقابل استبدال الأقدم، والفصل بين الكروت والمشتركين وتسلسل الأولوية (كرت ← حزمة ← عرض ← عام).",
                "icon": "mobile-screen-button",
                "template": "radius/docs_device_limit.html",
                "ready": True,
                "minutes": 9,
                "steps": 7,
            },
    ...
    "cards": {
        ...
        "pages": [
            ...
            },
            {
                "slug": "card-offers",
                "title": "عروض البطاقات",
                "desc": "العرض قالب جاهز (باقة + مدّة + سعر مقترح) ترث منه كل حزمة كروت تفاصيلها؛ الرؤية للمدراء، وحدّ الأجهزة على مستوى العرض.",
                "icon": "tags",
                "template": "radius/docs_card_offers.html",
                "ready": True,
                "minutes": 8,
                "steps": 6,
            },
    ...
    "network": {
        ...
        "pages": [
            ...
            {
                "slug": "tunnels",
                "title": "أنفاق الإدارة وسكربت التهيئة",
                "desc": "اربط راوترًا خلف NAT بلا IP ثابت عبر نفق إداري (SSTP/PPTP/WireGuard)، وشغّل سكربت التهيئة الجاهز على الراوتر وتحقّق من الاتصال.",
                "icon": "network-wired",
                "template": "radius/docs_tunnels.html",
                "ready": True,
                "minutes": 10,
                "steps": 6,
            },
            {
                "slug": "remote-access",
                "title": "الوصول البعيد وWinBox",
                "desc": "افتح جلسة إدارة مؤقّتة لراوتر (ويب/WinBox/SSH) عبر عنوان IP:port ينتهي تلقائيًّا، مع قيد مصدر وسجلّ تدقيق.",
                "icon": "key",
                "template": "radius/docs_remote_access.html",
                "ready": True,
                "minutes": 8,
                "steps": 6,
            },
            {
                "slug": "coa-ipchange",
                "title": "التحكّم الحيّ CoA وتغيير عنوان IP",
                "desc": "طبّق سرعة أو عنوانًا جديدًا على جلسة متّصلة دون فصل (CoA)، وافهم الفرق بين العنوان الداخلي LAN وعنوان التصفّح العامّ.",
                "icon": "arrows-rotate",
                "template": "radius/docs_coa_ipchange.html",
                "ready": True,
                "minutes": 9,
                "steps": 6,
            },
    ...
    "finance": {
        ...
        "pages": [
            ...
            {
                "slug": "credit-recharge",
                "title": "شحن الرصيد ولوحة الشحن",
                "desc": "من لوحة واحدة: جدّد اشتراك مشترك أو اشحن رصيده، حدّد المدفوع فورًا مقابل ما يبقى دينًا، واطبع الفاتورة — وأثرها المحاسبي.",
                "icon": "bolt",
                "template": "radius/docs_credit_recharge.html",
                "ready": True,
                "minutes": 8,
                "steps": 6,
            },
            {
                "slug": "distributors",
                "title": "الموزّعون",
                "desc": "أنشئ موزّعين، اشحن أرصدتهم واخصم منها، تابِع مبيعاتهم وديونهم، اعزل ملكيتهم لكل مدير، وحصّل المستحقّ عليهم.",
                "icon": "people-carry-box",
                "template": "radius/docs_distributors.html",
                "ready": True,
                "minutes": 9,
                "steps": 6,
            },
    ...
    "settings": {
        ...
        "pages": [
            ...
            {
                "slug": "manager-grants",
                "title": "صلاحيات المدير الدقيقة",
                "desc": "مصفوفة صلاحيات المدير: أقسام بثلاث حالات (كامل/قراءة/مخفيّ)، بوّابات لكل فعل، حدود حقليّة، قوالب جاهزة، سقوف إنفاق، ومدراء فرعيّون بطابور اعتماد.",
                "icon": "user-shield",
                "template": "radius/docs_manager_grants.html",
                "ready": True,
                "minutes": 10,
                "steps": 6,
            },
            ...
            {
                "slug": "migration",
                "title": "معالج ترحيل البيانات",
                "desc": "انقل مشتركيك وكروتك وباقاتك من نظام قديم بأمان: اربط الأعمدة، عايِن، شغّل تجريبيًّا بلا كتابة، ثم نفّذ (إنشاء غير الموجود ودمج الموجود).",
                "icon": "right-left",
                "template": "radius/docs_migration.html",
                "ready": True,
                "minutes": 10,
                "steps": 6,
            },
