...
### PPTP — خيار Legacy غير آمن (اختياري فقط)
PPTP غير آمن (MS-CHAPv2 مكسور) ومُهمَل. **لا يُوصى به ولا يكون الخيار
الافتراضي إطلاقًا.** أُتيح كبروتوكول ترافيك **ثانٍ اختياري** بطلب المشغّل،
للراوترات التي لا تدعم L2TP/IPsec، ويظهر دائمًا بوسم «غير آمن – Legacy»
مع تحذير في المعالج وفي صفحة العمليات. نفس نموذج التوجيه (scoped/full)
مثل L2TP/IPsec لكن **بلا طبقة IPsec**. الافتراضي يبقى L2TP/IPsec.

**استكشاف أعطال PPTP:**
- لا يتصل: راجع user/password، وتأكد أن منفذ TCP 1723 + GRE (proto 47)
  غير محجوبين على المسار/الـ VPS.
- يتصل ثم ينقطع: مشاكل MPPE/التفاوض — جرّب L2TP/IPsec بدلًا منه.
- الواجهة: `pptp-hoberadius-traffic` (idempotent، موسومة HobeRadius).
