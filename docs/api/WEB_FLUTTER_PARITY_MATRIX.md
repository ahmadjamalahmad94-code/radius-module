...
| Financial reports | `/admin/radius/finance/reports` | `/api/v1/reports/*`, `/api/v1/reports/snapshots`, `/api/v1/reports/*/export.csv`, `/api/v1/reports/*/export.xlsx` | `/reports` | partial | Ledger-based reports, immutable snapshots, CSV export, and Excel export exist in Web/Flutter. Real PDF export UX is still pending. |
