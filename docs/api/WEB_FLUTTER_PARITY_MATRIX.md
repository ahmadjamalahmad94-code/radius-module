...
| Financial reports | `/admin/radius/finance/reports` | `/api/v1/reports/*`, `/api/v1/reports/snapshots` | `/reports` | partial | Ledger-based reports and immutable snapshots exist in Web/Flutter. Real CSV/Excel/PDF export UX is still pending. |
