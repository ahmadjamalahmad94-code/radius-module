...
| Card batches | `/admin/radius/cards/batches` | `/api/v1/cards/batches`, `/api/v1/cards/batches/import`, `/api/v1/cards/batches/export.csv`, `/api/v1/cards/batches/export.xlsx`, `/api/v1/cards/batches/export.pdf` | `/cards`, `/cards/batches/<id>`, `/cards/import` | done | API-backed list/detail/actions/import and CSV/Excel/PDF exports exist on Web and Flutter. RADIUS-side behavior is not triggered for external files. |
