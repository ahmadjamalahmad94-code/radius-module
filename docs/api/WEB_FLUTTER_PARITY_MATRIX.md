...
| Financial reports | `/admin/radius/finance/reports` | `/api/v1/reports/*`, `/api/v1/reports/snapshots`, `/api/v1/reports/*/export.csv` | `/reports` | partial | Ledger-based reports, immutable snapshots, and CSV export exist in Web/Flutter. Real Excel/PDF export UX is still pending. |
